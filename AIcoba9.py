...
st.write("""
Aplikasi ini menampilkan segmen pelanggan yang dikelompokkan berdasarkan prediksi kepuasan. 
Pengguna dapat memilih segmen pelanggan tertentu untuk melihat detail ID pelanggan dan rekomendasi yang relevan. 
Dengan visualisasi yang mudah dipahami Insight Chart membantu bisnis dalam menganalisis kepuasan pelanggan dan memberikan solusi yang disesuaikan untuk mempermudah segmentasi pelanggan.
""")
